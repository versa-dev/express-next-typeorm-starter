...
const models: TsoaRoute.Models = {
    ...
    "UserRole": {
        "dataType": "refEnum",
        "enums": ["SUPER_ADMIN","ADMIN","STUDENT","TEACHER"],
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "UserStatus": {
        "dataType": "refEnum",
    ...
    "UserDto": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"status":{"ref":"UserStatus","required":true},"role":{"ref":"UserRole","required":true},"email":{"dataType":"string","required":true},"name":{"dataType":"string","required":true},"id":{"dataType":"string","required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "LoginPayload": {
        "dataType": "refAlias",
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/auth/register',
            ...
            const args = {
                    user: {"in":"body","name":"user","required":true,"ref":"RegisterUserInput"},
            };
        ...
        app.delete('/users/:userId',
            authenticateMiddleware([{"role":["SUPER_ADMIN"]}]),
        ...
        app.get('/users',
            authenticateMiddleware([{"role":["SUPER_ADMIN"]}]),
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.getAdminUsers)),

            function UserController_getAdminUsers(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getAdminUsers.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
